...
class Orders(Main_class):
    ...
    def __init__(self):
        ...
        # print(f"DEBUG: Loaded {len(self.items)} orders from {self.file_path}")
        # print(f"DEBUG: self.items = {self.items}")
    ...
    def select_products(self):
        print("\nSelect products:")
        self.products.print_items("Product List")
